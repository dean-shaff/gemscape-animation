...
const SpringSliders = (props) => {
  return (
    <div className="columns">
      ...
      <div className="column">
        <Slider val={props.tension} onChange={props.onChange} min={10} max={300} step={5} name="tension" title="Tension"/>
      </div>
      <div className="column">
        <Slider val={props.friction} onChange={props.onChange} min={10} max={200} step={5} name="friction" title="Friction"/>
      </div>
      {/*<div className="column">
